...
# taken from: https://way-too-mainstream.vercel.app/articles/add-auth-to-inertia-rails-app

# Store the CSRF token in a non-session cookie
...
module InertiaCsrf
  ...
  included do
    ...
    rescue_from ActionController::InvalidAuthenticityToken do
      redirect_back fallback_location: '/', notice: t('messages.page_expired')
    end
  end
